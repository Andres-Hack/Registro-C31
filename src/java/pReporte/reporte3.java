...
public class reporte3 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Statement statementBID = null, statementCTR = null, statementAct=null;
        ResultSet rsBID = null, rsCTR = null, rsAct=null;
        try {
            for (int i = 0; i < 5; i++) {
                int sw1 = i + 1;
         ...
         try{
            ...
            Document documento = new Document();
             ...
             PdfPCell celdaC = new PdfPCell(new Paragraph("SUB COMPONENTE / ACTIVIDAD", cabecera2));
