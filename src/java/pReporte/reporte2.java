...
public class reporte2 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Statement statement, statement2, statement3, statement4, statement1b,
                ...
                statement7b, statement8b, statement9b, statement10b, statement11b, statement12b, statement13b, statement14b;  
        ResultSet rs, rs2, rs3, rs4, rs1b,
                rs2b, rs3b, rs4b, rs5b, rs6b,
                rs7b, rs8b, rs9b, rs10b, rs11b, rs12b, rs13b, rs14b;
        ...
        try {
            ...
            statement13b = con.createStatement();
            statement14b = con.createStatement();
            ...
            rs10b = statement10b.executeQuery(consultaX+"18");
            rs11b = statement11b.executeQuery(consultaX+"19");
            rs12b = statement12b.executeQuery(consultaX+"20");
            rs13b = statement13b.executeQuery(consultaX+"21");
            rs14b = statement14b.executeQuery(consultaX+"22");
            ...
            while (rs12b.next()) { b12.add(rs12b.getString("detalle")); }
            while (rs13b.next()) { b13.add(rs13b.getString("detalle")); }
            while (rs14b.next()) { b14.add(rs14b.getString("detalle")); }
        ...
        try {
                ...
                //PdfWriter.getInstance(document, new FileOutputStream("MyPrimerPdf.pdf"));                
                document.open();
		...
		document.add(image);
                ...
                for(int p1=0;p1<a1.size();p1++) {
                    ...
                    if (montoAactB==0.0 && montoAactC==0.0) {
                        switch (p1){
                        ...
                        switch (p1){
                            ...
                            case 1:
                                 for(int p2=0;p2<b2.size();p2++) {
                                        ...
                                        tablesup.addCell(new Paragraph("        "+b2.get(p2), actividad));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactB)), montos));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactC)), montos));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactB+montoSubactC)), montos));
                                        sw=sw+1;
                            ...
                            case 2:
                                 for(int p2=0;p2<b3.size();p2++) {
                                        montoSubactB = Double.parseDouble(sub1B.get(sw));
                                        montoSubactC = Double.parseDouble(sub1C.get(sw));
                                        tablesup.addCell(new Paragraph("        "+b3.get(p2), actividad));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactB)), montos));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactC)), montos));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactB+montoSubactC)), montos));
                                        sw=sw+1;
                            ...
                            case 3:
                                 for(int p2=0;p2<b4.size();p2++) {
                                        montoSubactB = Double.parseDouble(sub1B.get(sw));
                                        montoSubactC = Double.parseDouble(sub1C.get(sw));
                                        tablesup.addCell(new Paragraph("        "+b4.get(p2), actividad));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactB)), montos));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactC)), montos));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactB+montoSubactC)), montos));
                                        sw=sw+1;
                    ...
                    if (montoAactB==0.0 && montoAactC==0.0) {
                        ...
                        tablesup.getDefaultCell().setBackgroundColor(BaseColor.WHITE);
                         switch (p1){
                            case 0: 
                                    for(int p2=0;p2<b6.size();p2++) {
                                        montoSubactB = Double.parseDouble(sub2B.get(p2));
                                        montoSubactC = Double.parseDouble(sub2C.get(p2));
                                        tablesup.addCell(new Paragraph("        "+b6.get(p2), actividad));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactB)), montos));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactC)), montos));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactB+montoSubactC)), montos));
                                        sw=sw+1;
                            ...
                            case 1:
                                for(int p2=0;p2<b5.size();p2++) {
                                        montoSubactB = Double.parseDouble(sub2B.get(sw));
                                        montoSubactC = Double.parseDouble(sub2C.get(sw));
                                        tablesup.addCell(new Paragraph("        "+b6.get(p2), actividad));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoAactB)), montos));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoAactC)), montos));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoAactB+montoAactC)), montos));
                    ...
                    if (montoAactB==0.0 && montoAactC==0.0) {
                        ...
                        switch (p1){
                            ...
                            case 1:
                                 ...
                                 break;
                            case 2:
                                 for(int p2=0;p2<b12.size();p2++) {
                                        montoSubactB = Double.parseDouble(sub4B.get(sw4));
                                        montoSubactC = Double.parseDouble(sub4C.get(sw4));
                                        tablesup.addCell(new Paragraph("        "+b12.get(p2), actividad));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactB)), montos));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactC)), montos));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactB+montoSubactC)), montos));
                                        sw4=sw4+1;
                                 ...
                                 break;
                            case 3:
                                 for(int p2=0;p2<b13.size();p2++) {
                                        montoSubactB = Double.parseDouble(sub4B.get(sw4));
                                        montoSubactC = Double.parseDouble(sub4C.get(sw4));
                                        tablesup.addCell(new Paragraph("        "+b13.get(p2), actividad));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactB)), montos));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactC)), montos));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactB+montoSubactC)), montos));
                                        sw4=sw4+1;
                                 ...
                                 break;
                            case 4:
                                 for(int p2=0;p2<b14.size();p2++) {
                                        montoSubactB = Double.parseDouble(sub4B.get(sw4));
                                        montoSubactC = Double.parseDouble(sub4C.get(sw4));
                                        tablesup.addCell(new Paragraph("        "+b14.get(p2), actividad));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactB)), montos));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactC)), montos));
                                        tablesup.addCell(new Paragraph(String.valueOf(df.format(montoSubactB+montoSubactC)), montos));
                                        sw4=sw4+1;
