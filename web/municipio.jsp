...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es" xml:lang="es"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript">
                    ...
                    <%
                                        ...
                                        consulta = "SELECT importe, importe_usd FROM tabla_c31 where id >= '1' ";
                                        ...
                                        while (rs1.next()) {  dd1 = dd1 + rs1.getFloat(estado); }
                                        while (rs2.next()) {  dd2 = dd2 + rs2.getFloat(estado); }
                                        while (rs3.next()) {  dd3 = dd3 + rs3.getFloat(estado); }
                                        while (rs4.next()) {  dd4 = dd4 + rs4.getFloat(estado); }
                                        while (rs5.next()) {  dd5 = dd5 + rs5.getFloat(estado); }
                                        while (rs6.next()) {  dd6 = dd6 + rs6.getFloat(estado); }
                                        while (rs7.next()) {  dd7 = dd7 + rs7.getFloat(estado); }
                                        while (rs8.next()) {  dd8 = dd8 + rs8.getFloat(estado); }
                                        while (rs9.next()) {  dd9 = dd9 + rs9.getFloat(estado); }
                                        while (rs10.next()) {  dd10 = dd10 + rs10.getFloat(estado); }
                                        while (rs11.next()) {  dd11 = dd11 + rs11.getFloat(estado); }
                                        while (rs12.next()) {  dd12 = dd12 + rs12.getFloat(estado); }
                                        while (rs13.next()) {  dd13 = dd13 + rs13.getFloat(estado); }
                                        while (rs14.next()) {  dd14 = dd14 + rs14.getFloat(estado); }
                                        if (gamuep != null) {
                                            switch (gamuep){
